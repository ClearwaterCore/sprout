...
public:
  ...
  MOCK_METHOD4(update_registration_state, HTTPCode(const std::string& public_user_identity,
                                                   const std::string& private_user_identity,
                                                   const std::string& type,
                                                   SAS::TrailId trail));

  MOCK_METHOD5(get_registration_data, HTTPCode(const std::string& public_user_identity,
                                               std::string& regstate,
