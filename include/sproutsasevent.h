...
namespace SASEvent
{
  ...
  const int BEGIN_SPROUTLET_REQ = SPROUT_BASE + 0x0110;
  const int BEGIN_SPROUTLET_RSP = SPROUT_BASE + 0x0111;
  const int BEGIN_STATEFUL_PROXY_REQ = SPROUT_BASE + 0x0112;
  const int BEGIN_STATEFUL_PROXY_RSP = SPROUT_BASE + 0x0113;
  const int BEGIN_AUTHENTICATION_MODULE = SPROUT_BASE + 0x0114;
  const int BEGIN_OPTIONS_MODULE = SPROUT_BASE + 0x0115;
  const int BEGIN_REGISTRAR_MODULE = SPROUT_BASE + 0x0116;
  const int BEGIN_SUBSCRIPTION_MODULE = SPROUT_BASE + 0x0117;
  const int BEGIN_THREAD_DISPATCHER = SPROUT_BASE + 0x0118;
